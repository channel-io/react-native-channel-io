...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CHDwifft/CHDwifft.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CHNavBar/CHNavBar.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CHSlackTextViewController/CHSlackTextViewController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CRToast/CRToast.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Cache/Cache.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ChannelIO/ChannelIO.framework"
